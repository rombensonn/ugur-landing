        ...
        <section class="section section-gridline">
            <div class="site-shell accuracy-layout">
                ...
                <div class="search-panel" aria-hidden="true">
                    <div class="search-input">Что беспокоит автомобиль?</div>
                    <label><input type="checkbox" checked> горит ошибка</label>
                    <label><input type="checkbox" checked> стук в ходовой</label>
                    <label><input type="checkbox"> рывки коробки</label>
                    <label><input type="checkbox"> замена ГРМ</label>
                </div>
            </div>
        </section>

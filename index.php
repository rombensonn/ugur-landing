...
$steps = [
    [
        'title' => 'Начните с описания',
        'text' => 'Марка авто, симптом и удобное время. Этого достаточно, чтобы мастер понял направление диагностики.',
        'visual' => 'request',
        'kicker' => 'Заявка',
        'headline' => 'Kia Rio, горит Check Engine',
        'rows' => [
            ['label' => 'Симптом', 'value' => 'потеря тяги'],
            ['label' => 'Когда удобно', 'value' => 'сегодня после 18:00'],
            ['label' => 'Что нужно', 'value' => 'диагностика'],
        ],
    ],
    [
        'title' => 'Получите расчет',
        'text' => 'По телефону сориентируем по работам, деталям и ближайшему окну записи.',
        'visual' => 'estimate',
        'kicker' => 'Предварительный расчет',
        'headline' => 'Работы, детали, окно записи',
        'rows' => [
            ['label' => 'Проверка', 'value' => 'сканер + осмотр'],
            ['label' => 'Детали', 'value' => 'по согласованию'],
            ['label' => 'Запись', 'value' => 'ближайшее окно'],
        ],
    ],
    [
        'title' => 'Согласуйте ремонт',
        'text' => 'После осмотра объясним причину, объем работ и стоимость до начала ремонта.',
        'visual' => 'approval',
        'kicker' => 'План ремонта',
        'headline' => 'Причина и цена понятны до старта',
        'rows' => [
            ['label' => 'Причина', 'value' => 'подтверждена'],
            ['label' => 'Работы', 'value' => 'согласованы'],
            ['label' => 'Статус', 'value' => 'можно начинать'],
        ],
    ],
];
                ...
                <div class="workflow-grid">
                    <?php foreach ($steps as $index => $step): ?>
                        <article class="workflow-card">
                            ...
                            <div class="workflow-preview workflow-preview-<?= escape_html($step['visual']) ?>" aria-label="<?= escape_html($step['headline']) ?>">
                                <div class="workflow-preview-top">
                                    <span><?= escape_html($step['kicker']) ?></span>
                                    <strong><?= escape_html($step['headline']) ?></strong>
                                </div>
                                ...
                                <?php if ($step['visual'] === 'request'): ?>
                                    <div class="workflow-animation workflow-animation-request" aria-hidden="true">
                                        <i></i><i></i><i></i>
                                    </div>
                                <?php elseif ($step['visual'] === 'estimate'): ?>
                                    <div class="workflow-animation workflow-animation-estimate" aria-hidden="true">
                                        <span></span>
                                    </div>
                                <?php else: ?>
                                    <div class="workflow-animation workflow-animation-approval" aria-hidden="true">
                                        <span>✓</span>
                                    </div>
                                <?php endif; ?>
                            </div>
        ...
        <section class="section section-gridline">
            <div class="site-shell photo-module">
                ...
                <div class="section-lead-copy">
                    ...
                    <h2>Посмотрите, где будут ремонтировать ваш автомобиль</h2>
                    <p>На фото — рабочая зона, подъемники, диагностическое оборудование и реальные машины в ремонте.</p>
